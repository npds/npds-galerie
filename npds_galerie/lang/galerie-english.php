...
function gal_translate($phrase) {
   switch ($phrase) {
      ...
      case "envoyée à la validation du webmaster": $tmp = "sent for webmaster validation"; break;
      ...
      case "image(s)": $tmp = "picture(s)"; break;
      ...
      case "Vous allez supprimer": $tmp = "You go to delete"; break;
